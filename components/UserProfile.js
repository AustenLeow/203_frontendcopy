        ...
        <div class="md:flex">
          <div class="w-full p-2 py-10">
            <div class="flex flex-col text-center mt-3 mb-4">
              <span class="text-2xl font-medium">Hi <strong><span class="text-lime-700 text-md font-bold"> {user.username} </span></strong> !</span>
              <span class="text-md text-gray-400">{user.email}</span>
            </div>

            <p class="px-16 text-center text-md text-gray-800">
            You have saved <span class="text-lime-700 text-md font-bold"> ${user.moneysaved} </span> dollars and <span class="text-lime-700 text-md font-bold">{user.carbonsaved} </span> pounds of carbon!
             </p>
