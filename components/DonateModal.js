...
export default function MyModal({ visible, onClose }) {
  ...
  function addOrder() {
    ...
    const res = fetch("https://9gbljis7zg.execute-api.ap-southeast-1.amazonaws.com/green/api/v1/order/donate", {
      method: "POST",
      headers: {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex items-center justify-center">
      <div className="absolute bg-white p-8 rounded-xl w-80">
        ...
        <div className="text-center p-4">
          ...
          <div className="pt-4">
            <a
              className="my-4 text-[#687259] hover:underline no-underline"
              href="/cart2"
            >
              No, let me go back
            </a>
