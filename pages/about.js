    ...
    <div>
      <Layout title="about">
        ...
        <div className="flex flex-col items-center justify-center text-center ">
          <div className="pb-4">
            <strong className="text-[#4E622E] underline">food wastage</strong> has been a
          ...
          <div className="pb-4">
            to achieve this goal, GreenFoodForYou was invented to be the bridge
            between consumers and businesses.{" "}
          </div>
          <div className="pb-4">
            GreenFoodForYou does this through its marketplace where customers
            can buy near-expired, good condition foods at a significantly
            cheaper price.{" "}
          </div>
          <div className="pb-4">
            GreenFoodForYou also provides statistics such as{" "}
            <strong className="text-[#4E622E] underline">carbon savings </strong>and{" "}
            <strong className="text-[#4E622E] underline">monetary savings </strong>for{" "}
